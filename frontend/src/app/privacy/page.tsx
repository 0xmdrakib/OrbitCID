...
export default function PrivacyPage() {
  return <main className="legal-main">
    <article className="legal-card">
      ...
      <section><h2>Control-plane data</h2><p>Neon Postgres stores your account, revocable session records, backend connection metadata, preferences, pairing state, and security activity. Tenant rows are protected by application authorization and forced PostgreSQL row-level security.</p></section>
      <section><h2>IPFS content and credentials</h2><p>IPFS file bytes stream between your browser and the backend you pair. They are not stored in the Vercel frontend or Neon database. Long-lived backend and optional Cloudflare R2 credentials remain on your backend; the browser receives only short-lived, audience-bound grants.</p></section>
