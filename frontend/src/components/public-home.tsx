  ...
  return <main className="public-main">
    <section className="hero">
      ...
      <div className="hero-copy">
        ...
        <p>OrbitCID gives every signed-in user an isolated control space on Vercel and Neon, then connects it to an IPFS backend they own—on a PC, VPS, or cloud server.</p>
      ...
      <div className="orbit-stage" aria-hidden="true">
        ...
        <div className="planet planet-neon"><Icon name="database"/><strong>Neon</strong><small>tenant-isolated state</small></div>
    ...
    <section className="section-heading" id="architecture"><p className="eyebrow">CLEAR RESPONSIBILITY</p><h2>Three layers.<br/>No blurred trust.</h2><p>The Vercel application never becomes your storage server. Neon stores account-level control state; content travels directly between your browser and the backend you paired.</p></section>
    <section className="architecture-grid">
      ...
      <article className="dark"><span className="step">02</span><Icon name="database" size={30}/><h3>Neon control state</h3><p>Each row is bound to the verified user ID. Forced Postgres RLS adds a database boundary below application authorization.</p><ul><li>Connections and preferences</li><li>Security activity trail</li><li>No IPFS file bytes</li></ul></article>
